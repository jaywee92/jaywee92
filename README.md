...
class jaywee92:
    def __init__(self):
        self.name = "Jochen Wahl"
        self.username = "jaywee92"
        self.location = "Berlin, Germany"
        self.education = "WBS Coding School"
        self.focus = ["Python", "JavaScript", "React", "AI"]
        self.background = "IT Infrastructure & Comm. Engineer"
